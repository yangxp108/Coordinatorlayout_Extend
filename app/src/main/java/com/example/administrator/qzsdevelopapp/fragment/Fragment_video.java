...
public class Fragment_video extends Fragment {
    ...
    public Fragment_video(AppCompatActivity mactivity){
...
//            mRecyclerView.addFootView(footerView);
    ...
    private void addData() {
        ...
        HttpUtil.post(getActivity(), "http://api.jisuapi.com/news/get?channel=娱乐&start="+num+"&num=10&appkey=49ac426389e3d7af", map, new HttpUtil.OnResultListener() {
            @Override
    ...
    public void newData() {
        Map<String,Object> map=new HashMap<>();
        HttpUtil.post(getActivity(), "http://api.jisuapi.com/news/get?channel=娱乐&start=0&num=10&appkey=49ac426389e3d7af", map, new HttpUtil.OnResultListener() {
            @Override
            public void onSuccess(String result) {
                //    LogUtil.e("秦子帅",result+"");
                Gson gson=new Gson();
        ...
        public void onBindViewHolder(MyViewHolder holder, final int position) {
            ...
            holder.tv_news_summary_digest.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    intent.putExtra("weburl",list.get(position).weburl+"");
