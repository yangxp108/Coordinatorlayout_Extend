...
import com.example.administrator.qzsdevelopapp.Utils.ToastUtil;
...
public class LinearFragment extends Fragment {
    ...
    public LinearFragment(AppCompatActivity mactivity){
...
//            mRecyclerView.addFootView(footerView);
    ...
    private void addData() {
            ...
            HttpUtil.post(getActivity(), "http://api.jisuapi.com/news/get?channel=体育&start="+num+"&num=10&appkey=49ac426389e3d7af", map, new HttpUtil.OnResultListener() {
                @Override
    ...
    public void newData() {
        Map<String,Object> map=new HashMap<>();
        HttpUtil.post(getActivity(), "http://api.jisuapi.com/news/get?channel=体育&start=0&num=10&appkey=49ac426389e3d7af", map, new HttpUtil.OnResultListener() {
            @Override
            public void onSuccess(String result) {
                //    LogUtil.e("秦子帅",result+"");
                Gson gson=new Gson();
